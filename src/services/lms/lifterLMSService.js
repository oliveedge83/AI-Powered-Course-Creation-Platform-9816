    ...
    export class LifterLMSService {
        ...
        return axios.post(
          `${this.baseUrl}/wp-json/llms/v1/courses`,
          {
            ...
            meta: {
              ...
              _llms_course_tracks: [],
              _llms_audio_embed: '',
              _llms_video_embed: 'https://www.youtube.com/watch?v=2pFHmjTUrCQ',
            },
          },
          {
      ...
      async createLesson(lesson,sectionId,fullContent=null,abortSignal=null) {
        ...
        if (fullContent) {
          ...
          <style>
            .llms-lesson-content {max-width: 100%;font-family: 'Segoe UI',Tahoma,Geneva,Verdana,sans-serif;line-height: 1.7;color: #374151;}
            .llms-lesson-content h1 {color: #1f2937;font-size: 28px;margin-bottom: 20px;padding-bottom: 10px;border-bottom: 3px solid #2563eb;}
            .llms-lesson-content h2 {color: #374151;font-size: 22px;margin: 25px 0 15px 0;padding-bottom: 8px;border-bottom: 2px solid #e5e7eb;}
            .llms-lesson-content h3 {color: #4b5563;font-size: 18px;margin: 20px 0 12px 0;font-weight: 600;}
            .llms-lesson-content p {margin-bottom: 16px;text-align: justify;}
            .llms-lesson-content ul,.llms-lesson-content ol {margin: 16px 0;padding-left: 24px;}
            .llms-lesson-content li {margin-bottom: 8px;}
          </style>
        `;
        }
