      ...
      const onSubmit = async (data) => {
        ...
        try {
          ...
          if (error.message.includes('API Key Validation Failed')) {
            ...
            errorMessage =
              'Invalid API key. Please check your API keys in settings.';
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          >
            <Card className="p-6 bg-gradient-to-r from-indigo-50 to-purple-50 border-indigo-200">
              <div className="flex items-center justify-between mb-4">
                ...
                <Button variant="secondary" size="sm" onClick={() => setShowNumberingExamples(!showNumberingExamples)} className="flex items-center space-x-2">
              ...
              <p className="text-indigo-800 mb-4">
                ...
                <code className="bg-indigo-200 px-2 py-1 rounded font-mono">1BMU28</code>) based on your selected domain and niche. All courses,
                topics, and lessons will be numbered hierarchically.
              </p>
              <AnimatePresence>
          ...
          >
            <Card className="p-6 bg-blue-50 border-blue-200">
              ...
              <Button onClick={handleValidateKeys} loading={validatingKeys} variant="secondary" className="flex items-center space-x-2">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="space-y-8">
              ...
              >
                <Button type="submit" loading={loading} size="xl" className="flex items-center space-x-3 px-12">
