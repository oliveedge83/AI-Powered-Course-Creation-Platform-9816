...
const {getActiveOpenAIKeys,getActivePerplexityKeys,getDecryptedLMSCredentials,getDecryptedAITableCredentials}=useSettingsStore(); // ✅ ADDED: AITable credentials
...
// ✅ ADDED: Get AITable credentials in a non-intrusive way
...
aitableCredentials // ✅ ADDED: Pass AITable credentials as the last parameter
);
