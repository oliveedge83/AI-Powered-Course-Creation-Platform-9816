    ...
    const ReviewDashboard=()=> {
      ...
      const handleRegenerateCourse=async ()=> {
        ...
        try {
          ...
          failGeneration(
            'Failed to regenerate course. Please check your API keys and try again.'
          );
        } finally {
        ...
        try {
          await generateCourseContent(
            ...
            vectorStoreAssignments,
            {
              ...
              perplexityApiKey:
                perplexityKeys.length > 0 ? perplexityKeys[0].key : null,
          ...
          if (error.message==='Request aborted by user') {
            ...
            failGeneration(
              'Content generation failed. Please check your API keys and LMS credentials.'
            );
          }
        } finally {
          setGenerating(false);
                        ...
                        <div className="grid grid-cols-3 gap-4 text-sm">
                          <div className="bg-white p-3 rounded border border-primary-200">
                            ...
                            <div className="text-primary-600">
                              {getGenreName(components.genre)}
                            </div>
                          </div>
                          <div className="bg-white p-3 rounded border border-primary-200">
                            <div className="font-medium text-primary-700">
                              Niche: {components.niche}
                            </div>
                            <div className="text-primary-600">
                              From "{currentProgram.niche}"
                            </div>
                          </div>
                          <div className="bg-white p-3 rounded border border-primary-200">
                            <div className="font-medium text-primary-700">
                            ...
                            <div className="text-primary-600">Unique identifier</div>
                          </div>
                        </div>
                      );
                    }
                    return (
                      <div className="text-red-600">Invalid program code format</div>
                    );
                  })()}
                </div>
              )}
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  <h5 className="font-medium text-gray-800 mb-2">
                    📚 Program Level (6 characters)
                  </h5>
                  <p className="text-sm text-gray-600 mb-2">
                    Format: [Genre][Niche][ID] → Example: 1BMU28
                  </p>
                  <div className="text-xs text-gray-500">
                    <div>• Genre: 1-6 (subject area)</div>
                    <div>• Niche: 3 letters (from program niche)</div>
                    <div>• ID: 2 digits (unique identifier)</div>
                  </div>
                </div>
                <div className="bg-gray-50 rounded-lg p-4">
                  <h5 className="font-medium text-gray-800 mb-2">
                    📖 Course Level (7 characters)
                  </h5>
                  <p className="text-sm text-gray-600 mb-2">
                    Format: [Program Code][Course#] → Example: 1BMU281
                  </p>
                  <div className="text-xs text-gray-500">
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  <h5 className="font-medium text-gray-800 mb-2">🎯 Topic Level</h5>
                  <p className="text-sm text-gray-600 mb-2">
                    Format: [Program Code]__[Course#][Topic#] → Example: 1BMU28__11
                  </p>
                  <div className="text-xs text-gray-500">
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  <h5 className="font-medium text-gray-800 mb-2">📝 Lesson Level</h5>
                  <p className="text-sm text-gray-600 mb-2">
                    Format: [Program Code]__[Topic Code][Lesson#] → Example:
                    1BMU28__111
                  </p>
                  <div className="text-xs text-gray-500">
                    <div>• Part 1: 6-character program code</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <Card className="p-4">
                <h4 className="font-semibold text-gray-900 mb-4 flex items-center">
                  <SafeIcon icon={FiZap} className="mr-2 text-purple-600" /> Basic
                  Configuration
                </h4>
                <div className="space-y-4">
                  <Select
              ...
              <Card className="p-4">
                <h4 className="font-semibold text-gray-900 mb-4 flex items-center">
                  <SafeIcon icon={FiSearch} className="mr-2 text-blue-600" /> Search
                  Configuration
                </h4>
                <div className="space-y-4">
                  <Select
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Comma-separated domain names to restrict search to specific
                      sites
                    </p>
                    {sonarConfig.domainFilter &&
                      !validateDomainFilter(sonarConfig.domainFilter) && (
              ...
              <Card className="p-4 md:col-span-2">
                <h4 className="font-semibold text-gray-900 mb-4 flex items-center">
                  <SafeIcon icon={FiMapPin} className="mr-2 text-green-600" /> User
                  Location (Optional)
                </h4>
                ...
                <p className="text-sm text-gray-600 mt-2">
                  Location information helps provide geographically relevant search
                  results
                </p>
              </Card>
            </div>
          ...
          >
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center space-x-3">
                ...
                <h3 className="text-xl font-bold">
                  Course Design Parameters Override
                </h3>
              </div>
              <Button
                variant="ghost"
            ...
            <div className="mb-6">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Override the program-level design parameters for this specific
                course. Leave parameters unchanged to inherit from program defaults.
              </p>
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start space-x-3">
                ...
                <p>
                  Knowledge libraries can be attached to topics or lessons to
                  enhance content with relevant information from your documents.
                </p>
              </div>
              <div className="flex items-start space-x-3">
                <div className="w-6 h-6 rounded-full bg-primary-100 text-primary-700 flex items-center justify-center flex-shrink-0 mt-0.5">
                ...
                <p>
                  Perplexity web search provides real-time context and current
                  industry insights for each lesson with configurable parameters.
                </p>
              </div>
              <div className="flex items-start space-x-3">
                <div className="w-6 h-6 rounded-full bg-primary-100 text-primary-700 flex items-center justify-center flex-shrink-0 mt-0.5">
                ...
                <p>
                  Design parameters ensure content matches your preferred
                  instructional approach and audience level.
                </p>
              </div>
            </div>
        ...
        >
          ...
          >
            ...
            <div className="flex justify-end space-x-3">
              ...
              <Button onClick={handleSaveTopicContext}>Save Context</Button>
            </div>
          </motion.div>
        </motion.div>
      );
        ...
        >
          ...
          >
            ...
            <div className="flex justify-end space-x-3">
              ...
              <Button onClick={handleSaveLessonContext}>Save Context</Button>
            </div>
          </motion.div>
        </motion.div>
      );
      ...
      return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <AnimatePresence>
            ...
            {showProgramCodeInfo && <ProgramCodeInfoModal />}
          </AnimatePresence>
              ...
              <div>
                ...
                {currentProgram.programCode && (
                  <div className="mt-3 flex items-center space-x-2">
                    <div className="inline-flex items-center px-3 py-1 rounded-full text-sm bg-primary-100 text-primary-800 font-mono">
                      <SafeIcon icon={FiHash} className="mr-1" /> Program Code:{' '}
                      {currentProgram.programCode}
                    </div>
                    <Button
                      variant="ghost"
              ...
              <Card className="p-4 bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200">
                ...
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h3 className="font-medium text-blue-800">
                        Research-Enhanced Program
                      </h3>
                      <p className="text-blue-700 text-sm">
                        This program was generated using{' '}
                        {currentProgram.researchEnhanced
                          ? 'real-time industry research'
                          : 'enhanced AI analysis'}{' '}
                        {currentProgram.usedSonarProStructure &&
                          ' with Sonar-Pro structure generation'}
                      </p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-2">
                    ...
                    <SafeIcon
                      icon={citationsExpanded ? FiChevronUp : FiChevronDown}
                    ...
                    >
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {currentProgram.researchCitations?.length > 0 && (
                          <div>
                            <h4 className="font-medium text-blue-800 mb-2 flex items-center">
                              ...
                              Industry Research (
                              {currentProgram.researchCitations.length} sources)
                            </h4>
                        ...
                        {currentProgram.structureCitations?.length > 0 && (
                          <div>
                            <h4 className="font-medium text-blue-800 mb-2 flex items-center">
                              <SafeIcon icon={FiBook} className="mr-2" /> Structure
                              Generation ({currentProgram.structureCitations.length}{' '}
                              sources)
                              {currentProgram.usedSonarProStructure && (
            ...
            <div className="lg:col-span-1">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="p-4 bg-purple-50 border border-purple-200 rounded-lg">
                      <div className="flex items-center justify-between mb-3">
                        ...
                        >
                          <SafeIcon icon={FiEdit3} className="mr-1" /> Override
                        </Button>
                      </div>
                    ...
                    <div className="p-4 bg-purple-50 border border-purple-200 rounded-lg">
                      ...
                      <label className="flex items-center space-x-3 mb-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-purple-700 mt-1">
                            Generate real-time web research context for each lesson
                      ...
                      {usePerplexityWebSearch && (
                        <div className="mt-3 pt-3 border-t border-purple-200">
                          ...
                          <p className="text-xs text-purple-700 mt-1">
                            Model: {sonarConfig.sonarModel} | Context:{' '}
                            {sonarConfig.searchContextSize} | Recency:{' '}
                            {sonarConfig.searchRecency}
                          </p>
                        </div>
                      )}
                      {usePerplexityWebSearch &&
              ...
              <Card className="p-6 mt-6 bg-gradient-to-r from-primary-50 to-primary-100 border-primary-200">
                ...
                <ul className="text-sm text-primary-700 space-y-2">
                  ...
                  <li className="flex items-start">
                    ...
                    />
                    <span>
                      Knowledge library integration for relevant content
                    </span>
                  </li>
                  <li className="flex items-start">
                    <SafeIcon
              ...
              <Card className="p-6 mt-6 bg-gradient-to-r from-purple-50 to-purple-100 border-purple-200">
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <h3 className="font-medium text-purple-800">
                    Advanced Web Search Enhancement
                  </h3>
                </div>
                ...
                <ul className="text-sm text-purple-700 space-y-2">
                  <li className="flex items-start">
                    <div className="w-5 h-5 rounded-full bg-purple-200 text-purple-700 flex items-center justify-center flex-shrink-0 mr-2">
                      1
                    </div>
                    <span>
                      Generate topic-level web search context for current trends
                    </span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-5 h-5 rounded-full bg-purple-200 text-purple-700 flex items-center justify-center flex-shrink-0 mr-2">
                    ...
                    <span>
                      Create lesson-specific web research context (300-400 tokens
                      each)
                    </span>
                  </li>
                  <li className="flex items-start">
                    ...
                    <span>
                      Integrate real-time industry insights and current examples
                    </span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-5 h-5 rounded-full bg-purple-200 text-purple-700 flex items-center justify-center flex-shrink-0 mr-2">
              ...
              <Card className="p-6 mt-6 bg-gradient-to-r from-blue-50 to-blue-100 border-blue-200">
                ...
                <ul className="text-sm text-blue-700 space-y-2">
                  <li className="flex items-start">
                    <div className="w-5 h-5 rounded-full bg-blue-200 text-blue-700 flex items-center justify-center flex-shrink-0 mr-2">
                      1
                    </div>
                    <span>
                      Add a library to a topic to use for all its lessons
                    </span>
                  </li>
                  <li className="flex items-start">
                    <div className="w-5 h-5 rounded-full bg-blue-200 text-blue-700 flex items-center justify-center flex-shrink-0 mr-2">
                    ...
                    <span>
                      Add a library to a specific lesson to override topic-level
                      library
                    </span>
                  </li>
                  <li className="flex items-start">
                  ...
                  <li className="flex items-start">
                    ...
                    <span>
                      AI will use your documents as context for generation
                    </span>
                  </li>
                </ul>
              </Card>
            ...
            <div className="lg:col-span-2">
              {selectedCourse ? (
                ...
                <Card className="p-12 text-center">
                  ...
                  <p className="text-gray-600">
                    Choose a course from the left panel to view and edit its
                    content.
                  </p>
                </Card>
              )}
